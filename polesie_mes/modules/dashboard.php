...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <ul class="nav-menu">
            <li>
                <a href="<?= APP_URL ?>/modules/dashboard.php" class="nav-link <?= ($currentPage ?? '') == 'dashboard' ? 'active' : '' ?>">
            ...
            <li>
                <a href="<?= APP_URL ?>/modules/orders.php" class="nav-link">
            ...
            <li>
                <a href="<?= APP_URL ?>/modules/production.php" class="nav-link">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div style="display: flex; gap: 0.75rem; align-items: center;">
                            ...
                            <a href="<?= APP_URL ?>/modules/orders.php" class="card-link">Все заказы →</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <!-- Table View -->
