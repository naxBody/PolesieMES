...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="<?= APP_URL ?>/modules/shipment.php" class="nav-link"><i class="fas fa-truck"></i> Отгрузка</a></li>
            <li><a href="<?= APP_URL ?>/modules/gost_docs.php" class="nav-link active"><i class="fas fa-file-contract"></i> ГОСТ Документы</a></li>
        </ul>
